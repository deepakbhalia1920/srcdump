...
# Copy files to VM
SCRIPT_FILES=("newset_ecomm_fashion_pre_sql.sh" "newset_ecomm_fashion_presql.sql")
...
gcloud compute ssh "${INSTANCE_NAME}" --zone="${ZONE_NAME}" --command="bash ${TGT_PATH}newset_ecomm_fashion_pre_sql.sh"
